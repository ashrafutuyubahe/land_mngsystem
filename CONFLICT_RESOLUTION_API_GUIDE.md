...
```json
{
  ...
  "witnessSignatures": ["mediator", "complainant", "respondent", "local_authority"]
}
```
...
```json
{
  ...
  "resolutionDocuments": ["mediation_agreement.pdf", "boundary_survey.pdf", "compensation_receipt.pdf"],
  "followUpActions": ["Update land registry", "File resolution documents", "Monitor compliance"],
